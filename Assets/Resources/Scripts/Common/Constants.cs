...
public class Constants  
{
    ...
    public const string UIMenuExtentBtn = "uiExtenBtn";
    public const string UIOpenPage = "uiOpenPage";
    public const string FBItemEnter = "fbitem";
    public const string FBLose = "fblose";
    public const string FBLogoEnter = "fbitem";
    ...
    //运动平滑加速度
    public const float AcclerSpeed = 5;
    public const float AcclerHPSpeed = 0.1f;
